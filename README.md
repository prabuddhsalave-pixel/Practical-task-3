...
-- Task 3: Create a table named accounts with the given columns.
...
UPDATE accounts SET account_category = 'Retail' WHERE account_id = 1001;
UPDATE accounts SET account_category = 'Corporate' WHERE account_id = 1002;

ALTER TABLE accounts RENAME TO bank_accounts;

-- Task 60: Display the structure of bank_accounts, then remove all records using
-- TRUNCATE TABLE and finally delete the table using DROP TABLE.
